...
G4_DECLARE_PHYSCONSTR_FACTORY(H2PhysicsList);

using namespace CLHEP;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

H2PhysicsList::H2PhysicsList() 
...
void H2PhysicsList::ConstructParticle()
{
...
void H2PhysicsList::ConstructProcess()
{
//  AddTransportation();
//  ConstructDecay();
//  ConstructEM();
...
/*
void H2PhysicsList::ConstructDecay()
{
  // Add Decay Process
...
/*
void H2PhysicsList::ConstructEM()
{
  theParticleIterator->reset();
  while( (*theParticleIterator)() ){
    G4ParticleDefinition* particle = theParticleIterator->value();
...
void H2PhysicsList::ConstructOp()
{
...
void H2PhysicsList::SetVerbose(G4int verbose)
{
